    ...
    try:
        ...
        if sleep_data and sleep_data.get("enabled", False):
            ...
            await message.answer(
                ...
                f"⚠️ Внимание: Магазин автоматически уходит в сон при достижении 20 заказов. "
...
• Заказы отправляются пачками для оптимизации доставки
• Магазин автоматически уходит в сон при достижении 20 заказов
...
• Убедитесь, что вы будете находиться по указанному адресу в течение 2-3 часов
• Встречайте курьера лично - возврат средств невозможен
• Если вы не встретите курьера, деньги не возвращаются"""
